...
<template>
  <section
    class="public-hero landing-hero"
    :style="{ backgroundImage: `linear-gradient(90deg, rgba(15, 23, 42, 0.80), rgba(15, 23, 42, 0.34)), url(${widgetPreviewUrl})` }"
  >
    <div class="public-hero-inner landing-hero-copy">
      <span class="eyebrow">
