    ...
    public static function all(): array
    {
        return [
            'bigshop' => self::entry(
                ...
                priority: true,
                summary: 'Integracao preferencial com ativacao assinada, sync de produtos por API ou XML e caminho para instalacao nativa.',
                steps: [
                    'No painel da BigShop, autorize o app Provador Virtual ou informe store_id, token x-api e/ou URL do XML dominio/feed.xml.',
                    'Teste a conexao e sincronize produtos, grades e tabelas disponiveis por API ou XML.',
                ...
                dataSupport: [
                    ...
                    'xml_feed' => 'Nativo dominio/feed.xml',
                    'feed_api' => 'Sync API',
...
HTML
            ...
            'loja_integrada' => self::entry(
                ...
                dataSupport: [
                    ...
                    'xml_feed' => 'Feed/exportacao quando habilitado',
                    'feed_api' => 'API/feed',
                    'orders_returns' => 'Pendente API',
                ],
            ...
            'magento' => self::entry(
                ...
                dataSupport: [
                    ...
                    'xml_feed' => 'Google XML via modulo',
                    'feed_api' => 'REST API',
                    'orders_returns' => 'Pendente API',
                ],
