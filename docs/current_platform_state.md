...
- Sprint 144 amplia `/app/sincronizacao` com erros por produto implementados localmente: grupos por causa raiz, contexto de produto/variação/SKU/tamanhos/categoria/marca/URL, ações para vincular tabela, revisar categoria/regra, reprocessar e ignorar com motivo, exportação CSV e auditoria de resolução.
