...
- Painel SaaS protegido por papel/permissão: `/saas`, `/saas/empresas`, `/saas/usuarios`, `/saas/checkout`, `/saas/pedidos`, `/saas/trocas-bigshop` e `/saas/emails`, com entrada administrativa em `/saas/login`.
