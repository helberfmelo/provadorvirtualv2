...
- Sprint 76 remove a escala redundante de nota de 1 a 5 do feedback final do widget, mantendo apenas `Sim, ajudou`, `Não ajudou`, tamanho escolhido e comentário.
