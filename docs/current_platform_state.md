...
- Sprint 141 amplia `/app/integracoes` com exemplos de API por plataforma, webhook assinado testável sem expor segredo, GTM opcional/fallback e diagnóstico granular da instalação por URL validada.
