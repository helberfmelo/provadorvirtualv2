...
- Sprint 145 amplia `/app/regras-de-importacao` com simulação de impacto implementada localmente: regras propostas são comparadas com as atuais em modo somente leitura, retornando antes/depois por produto, produtos afetados, uso de fallback, obrigatórios ausentes, conflitos e bloqueio de salvamento quando houver conflito crítico.
